...
def generalized_phase(waveData, dataBucketName = ''):
    ...
    dataBucket = wd.DataBucket(outcome, "complexData", currentDimord,sampleRate=waveData.get_sample_rate() ,chanNames=waveData.DataBuckets[waveData.ActiveDataBucket].get_channel_names())
    if hasBeenReshaped:
